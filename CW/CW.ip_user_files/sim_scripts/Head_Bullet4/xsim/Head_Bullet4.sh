...
#
# Script generated by Vivado on Fri Jan 10 22:30:29 +0000 2025
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : Head_Bullet4.sh
...
#
# Usage        : Head_Bullet4.sh
#                Head_Bullet4.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Head_Bullet4.sh [-reset_run]
#                Head_Bullet4.sh [-reset_log]
#                Head_Bullet4.sh [-help]
#
...
# script info
echo -e "Head_Bullet4.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Head_Bullet4.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot Head_Bullet4 xil_defaultlib.Head_Bullet4 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Head_Bullet4 -key {Behavioral:sim_1:Functional:Head_Bullet4} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/SOMUCHSPACE/Vivado/2024.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Head_Bullet4.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Head_Bullet4.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Head_Bullet4.sh [-help]\n\
Usage: Head_Bullet4.sh [-step]\n\
Usage: Head_Bullet4.sh [-lib_map_path]\n\
Usage: Head_Bullet4.sh [-reset_run]\n\
Usage: Head_Bullet4.sh [-reset_log]\n\
Usage: Head_Bullet4.sh [-keep_index]\n\
Usage: Head_Bullet4.sh [-noclean_files]\n\n\
