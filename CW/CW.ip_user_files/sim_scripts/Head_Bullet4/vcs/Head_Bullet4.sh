...
#                script (type 'Head_Bullet4.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.Head_Bullet4 xil_defaultlib.glbl -o Head_Bullet4_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./Head_Bullet4_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key Head_Bullet4_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc Head_Bullet4_simv.daidir vcs_lib c.obj)
