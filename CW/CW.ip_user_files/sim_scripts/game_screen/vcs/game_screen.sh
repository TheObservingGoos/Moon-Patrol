...
#                script (type 'game_screen.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.game_screen xil_defaultlib.glbl -o game_screen_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./game_screen_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key game_screen_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc game_screen_simv.daidir vcs_lib c.obj)
