...
#
# Script generated by Vivado on Mon Jan 13 07:12:57 +0000 2025
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : game_screen.sh
...
#
# Usage        : game_screen.sh
#                game_screen.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                game_screen.sh [-reset_run]
#                game_screen.sh [-reset_log]
#                game_screen.sh [-help]
#
...
# script info
echo -e "game_screen.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./game_screen.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot game_screen xil_defaultlib.game_screen xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim game_screen -key {Behavioral:sim_1:Functional:game_screen} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb game_screen.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./game_screen.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: game_screen.sh [-help]\n\
Usage: game_screen.sh [-step]\n\
Usage: game_screen.sh [-lib_map_path]\n\
Usage: game_screen.sh [-reset_run]\n\
Usage: game_screen.sh [-reset_log]\n\
Usage: game_screen.sh [-keep_index]\n\
Usage: game_screen.sh [-noclean_files]\n\n\
