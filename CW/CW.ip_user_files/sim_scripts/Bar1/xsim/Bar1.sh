...
#
# Script generated by Vivado on Wed Jan 15 21:24:07 +0000 2025
...
#
# Usage        : Bar1.sh
#                Bar1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Bar1.sh [-reset_run]
#                Bar1.sh [-reset_log]
#                Bar1.sh [-help]
#
...
# script info
echo -e "Bar1.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Bar1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot Bar1 xil_defaultlib.Bar1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Bar1 -key {Behavioral:sim_1:Functional:Bar1} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Bar1.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Bar1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Bar1.sh [-help]\n\
Usage: Bar1.sh [-step]\n\
Usage: Bar1.sh [-lib_map_path]\n\
Usage: Bar1.sh [-reset_run]\n\
Usage: Bar1.sh [-reset_log]\n\
Usage: Bar1.sh [-keep_index]\n\
Usage: Bar1.sh [-noclean_files]\n\n\
