...
#                script (type 'Head_Bullet3.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.Head_Bullet3 xil_defaultlib.glbl -o Head_Bullet3_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./Head_Bullet3_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key Head_Bullet3_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc Head_Bullet3_simv.daidir vcs_lib c.obj)
