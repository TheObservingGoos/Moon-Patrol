...
#
# Script generated by Vivado on Tue Dec 31 19:43:36 +0000 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : disp_sim.sh
...
#
# Usage        : disp_sim.sh
#                disp_sim.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                disp_sim.sh [-reset_run]
#                disp_sim.sh [-reset_log]
#                disp_sim.sh [-help]
#
...
# script info
echo -e "disp_sim.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./disp_sim.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xpm -L xil_defaultlib -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot disp_sim xil_defaultlib.disp_sim xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim disp_sim -key {Behavioral:sim_1:Functional:disp_sim} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb disp_sim.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./disp_sim.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: disp_sim.sh [-help]\n\
Usage: disp_sim.sh [-step]\n\
Usage: disp_sim.sh [-lib_map_path]\n\
Usage: disp_sim.sh [-reset_run]\n\
Usage: disp_sim.sh [-reset_log]\n\
Usage: disp_sim.sh [-keep_index]\n\
Usage: disp_sim.sh [-noclean_files]\n\n\
