...
#                script (type 'disp_sim.sh -help' for more information).
#
...
compile()
{
  ...
  "../../../../Lab/ 6/Lab/ 6.srcs/sources_1/new/vga_out.v" \
  "../../../../Lab/ 6/Lab/ 6.srcs/sim_1/new/disp_sim.v" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.disp_sim xil_defaultlib.glbl -o disp_sim_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./disp_sim_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key disp_sim_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc disp_sim_simv.daidir vcs_lib c.obj)
