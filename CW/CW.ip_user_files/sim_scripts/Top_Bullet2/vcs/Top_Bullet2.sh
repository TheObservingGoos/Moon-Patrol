...
#                script (type 'Top_Bullet2.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.Top_Bullet2 xil_defaultlib.glbl -o Top_Bullet2_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./Top_Bullet2_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key Top_Bullet2_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc Top_Bullet2_simv.daidir vcs_lib c.obj)
